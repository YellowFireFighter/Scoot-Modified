--[[
    scoot ui library
    made by samet 
    modified by yellow
]]
...
local Library do
        ...
        Instances.MakeDraggable = function(self)
            ...
            self:Connect("InputBegan", function(Input)
                if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
                    ...
                    -- Wait for size to calculate if using AutomaticSize
                    ...
                    InputChanged = Input.Changed:Connect(function()
                        if Input.UserInputState == Enum.UserInputState.End then
                            ...
                            if DragOutline then
                                ...
                                -- Tween to final position using library settings
    ...
    Library.KeybindList = function(self)
        ...
        local function UpdateSize()
            -- Wait for size to calculate
            task.wait()
            
            -- Calculate visible keybinds and max width
            local VisibleCount = 0
            local MaxWidth = 116 -- Minimum width (to fit "Keybinds" title)
            ...
            -- Calculate new height: base height (32) + (keybind height (15) + padding (4)) * visible count
            local BaseHeight = 32
            local KeybindHeight = 15
            local Padding = 4
            local NewHeight = BaseHeight + ((KeybindHeight + Padding) * VisibleCount)
            
            -- Tween both width and height
            ...
            function NewKey:SetStatus(Bool)
                if Bool then
                    ...
                    fadeOutTween.Tween.Completed:Connect(function()
                        ...
                        -- Update size after item is hidden
                        UpdateSize()
                    end)
                end
            end
    ...
    Library.Notification = function(self, Title, Description, Duration)
        local Items = { } do 
            ...
            -- Container for inline title and description
        ...
        Library:Thread(function()
            ...
            -- Set initial position off-screen to the left using X offset
            Items["Notification"].Instance.Position = UDim2New(0, -TargetSize.X - 50, 0, 0)
            
            -- Slide in from left and fade in simultaneously
            local slideInTween = Items["Notification"]:Tween(
                TweenInfo.new(0.4, Enum.EasingStyle.Quart, Enum.EasingDirection.Out),
                {Position = UDim2New(0, 0, 0, 0)} -- Slide to normal position
            )
                ...
                linerFadeTween.Tween.Completed:Connect(function()
                    ...
                    lineTween.Tween.Completed:Connect(function()
                        ...
                        local slideOutTween = Items["Notification"]:Tween(
                            ...
                            {Position = UDim2New(0, -TargetSize.X - 50, 0, 0)} -- Slide off-screen to the left
                        )
    ...
    Library.InventoryViewer = function(self)
        ...
        local function UpdateInventorySize()
            -- Small delay to let UI calculate
            Library:Thread(function()
                task.wait()
                
                -- Get the actual calculated size of the tools frame
                local ToolsHeight = Items["Tools"].Instance.AbsoluteSize.Y
                
                -- If the tools frame is too small (no items), set minimum
                if ToolsHeight < 20 then
                    ToolsHeight = 20
                end
                
                -- Calculate width to fit exactly 4 items with perfect spacing
                -- Content: 4 cells (65 each) + 3 gaps (4 each) = 272px
                -- Add Holder padding: left (8) + right (8) = 288px
                -- Add Tools borders: left (2) + right (2) = 292px  
                -- Add Tools margins: left (8) + right (8) = 308px
                -- Add InventoryViewer borders: left (2) + right (2) = 312px
                local FinalWidth = 304
                
                -- Total height: 27 (top) + tools height + 8 (spacing) + 68 (player info)
